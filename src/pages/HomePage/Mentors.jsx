  ...
  return (
    <div className="mentors-container">
      <div>
        ...
        <p>Caso não queira buscar, basta se conectar</p>
        <div className="mentors-list">
          {users.map((user) => (
            <div className="mentor" key={user.id}>
              ...
              <div className="icon-teams">
                <img
                  src="https://img.icons8.com/color/344/microsoft-teams.png"
                  alt=""
                />
              </div>
              ...
              <div className="connect-box">
                <p className="item">Disponibilidade</p>
                <p className="item">{user.status}</p>
                <button className="item">Conectar</button>
              </div>
            </div>
          ))}
        </div>
